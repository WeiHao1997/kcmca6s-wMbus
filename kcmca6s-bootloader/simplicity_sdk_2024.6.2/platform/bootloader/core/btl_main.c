...
#ifndef __QUEC_SUPPORT_SDK__
#include "ql_bootloader.h"
#endif /* __QUEC_SUPPORT_SDK__ */
...
int main(void)
{
  ...
  CHIP_Init();
    ...
    ql_bootloader_info_t boot_info =
    {
        .appStartAddr   = BTL_APPLICATION_BASE,
        .flashMaxSize   = BTL_APPLICATION_BASE + BTL_APP_SPACE_SIZE,
        .resetReason     = reset_getResetReason(),
    };
    ql_bootloader_sequence_start(&boot_info);
#endif /* __QUEC_SUPPORT_SDK__ */
...
#ifndef __QUEC_SUPPORT_SDK__
  ql_bootloader_check_reset_reason(&(enterApp), &(verifyApp));
#endif /* __QUEC_SUPPORT_SDK__ */
